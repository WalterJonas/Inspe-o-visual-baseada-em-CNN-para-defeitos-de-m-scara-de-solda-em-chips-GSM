...
class Provir3(object):
    ...
    def loadDataset(self, path, X_train, Y_train, X_trainN, Y_trainN):
        ...
        for i in range(len(self.files)):
            ...
            imgN = random_noise(img, mode='s&p', salt_vs_pepper=0.5, amount=0.005) #Pode modificar a densidade no parametro "amount"   
            imgN = np.array(255*imgN, dtype='uint8')
...
if __name__ == '__main__':
    ...
    #-------------CNN FITTING--------------------
    scores, histories, svm_accuracies = obj.evaluate_model(obj.X_train, obj.Y_train, obj.X_test, obj.Y_test, obj.X_trainN, obj.Y_trainN, obj.X_testN, obj.Y_testN)
